...
class ProductForm extends HTMLElement {
  constructor() {
    ...
    this.qtyInputs = this.querySelectorAll('[data-qty-input][name="quantity"]');
    this.qtyInputs.forEach(qtyInput => qtyInput.addEventListener('keyup', this.manageQtyInput.bind(this)));
